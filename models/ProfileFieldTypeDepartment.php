...
/**
 * ProfileFieldTypeDepartment handles text area profile fields.
 *
 * @package humhub.modules_core.user.models
 * @since 0.5
 */
class ProfileFieldTypeDepartment extends ProfileFieldType {
    ...
    public function getFormDefinition($definition = array()) {
        return parent::getFormDefinition(array(
                    get_class($this) => array(
                        'type' => 'form',
                        'title' => Yii::t('UserModule.models_ProfileFieldTypeDepartment', 'Text area field options'),
                        'elements' => array(
                        )
        )));
    }
    ...
    {
        $items = CHtml::listData(CompanyStructures::model()->findAllByAttributes(array('type' => 'Department')), 'id', 'title');
        return $items;
    }
