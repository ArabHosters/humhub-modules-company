...
/**
 * ProfileFieldTypePayGrades handles text area profile fields.
 *
 * @package humhub.modules_core.user.models
 * @since 0.5
 */
class ProfileFieldTypePayGrades extends ProfileFieldType {
    ...
    public function getFormDefinition($definition = array()) {
        return parent::getFormDefinition(array(
                    get_class($this) => array(
                        'type' => 'form',
                        'title' => Yii::t('UserModule.models_ProfileFieldTypePayGrades', 'Text area field options'),
                        'elements' => array(
                        )
        )));
    }
    ...
    {
        $items = CHtml::listData(PayGrades::model()->findAll(), 'id', 'name');
        return $items;
    }
