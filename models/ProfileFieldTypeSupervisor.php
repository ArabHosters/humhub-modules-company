...
/**
 * ProfileFieldTypeSupervisor handles text area profile fields.
 *
 * @package humhub.modules_core.user.models
 * @since 0.5
 */
class ProfileFieldTypeSupervisor extends ProfileFieldType {
    ...
    public function getFormDefinition($definition = array()) {
        return parent::getFormDefinition(array(
                    get_class($this) => array(
                        'type' => 'form',
                        'title' => Yii::t('UserModule.models_ProfileFieldTypeSupervisor', 'Text area field options'),
                        'elements' => array(
                        )
        )));
    }
    ...
    {
        $items = CHtml::listData(User::model()->findAll(), 'id', 'displayName');
        return $items;
    }
