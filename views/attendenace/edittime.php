    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <strong>Review</strong> Attendance
            </h4>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group">
		<?php echo $form->labelEx($attendance,'status'); ?>
		<?php echo $form->dropdownList($attendance, 'status', array('Pending'=>'Pending','Approved'=>'Approved','Rejected'=>'Rejected'), array('class' => 'form-control', 'empty' => 'Select')); ?>
		<?php echo $form->error($attendance,'status'); ?>
	</div>
        ...
        <div class="modal-footer">
            ...
            <?php
            echo HHtml::ajaxButton('Save', Yii::app()->createUrl("//company/attendenace/editAttendance", array("id" => $attendance->id)), array(
                'type' => 'POST',
