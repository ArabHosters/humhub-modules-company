<div class="form-group col-md-10">
        ...
        <div class="col-sm-5">
            <?php echo CHtml::activeDropDownList($model, "[$index]component_id", CHtml::listData(SalaryComponent::model()->findAllByAttributes(array('type' => 1)), 'id', 'name'), array('empty' => 'Select Component', 'class' => 'form-control')); ?>
        </div>
    </div>