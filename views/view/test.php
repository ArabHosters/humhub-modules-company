                                                ...
                                                <tr class="users_details">
                                                    ...
                                                    <td class="colWorkHour">
                                                        <div class="btn-toolbar">
                                                            <div class="btn-group"><button type="button" class="btn tdBtn btn-default day-none" user="349092">None</button></div>
                                                            <div class="btn-group week" data-toggle="buttons">
                                                                ...
                                                                ?>
                                                                <label class="btn btn-default <?php echo (isset($user_days['sat'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['sat'])) ? 'checked' : ''; ?> value="sat" name="d[<?php echo $user->id; ?>][]">Sat</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['sun'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['sun'])) ? 'checked' : ''; ?> value="sun" name="d[<?php echo $user->id; ?>][]">Sun</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['mon'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['mon'])) ? 'checked' : ''; ?> value="mon" name="d[<?php echo $user->id; ?>][]">Mon</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['tue'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['tue'])) ? 'checked' : ''; ?> value="tue" name="d[<?php echo $user->id; ?>][]">Tue</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['wed'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['wed'])) ? 'checked' : ''; ?> value="wed" name="d[<?php echo $user->id; ?>][]">Wed</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['thu'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['thu'])) ? 'checked' : ''; ?> value="thu" name="d[<?php echo $user->id; ?>][]">Thu</label>
                                                                <label class="btn btn-default <?php echo (isset($user_days['fri'])) ? 'active' : ''; ?>"><input type="checkbox" <?php echo (isset($user_days['fri'])) ? 'checked' : ''; ?> value="fri" name="d[<?php echo $user->id; ?>][]">Fri</label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="colMinHour">
