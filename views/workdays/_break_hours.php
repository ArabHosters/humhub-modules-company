<div class="colMinHour">
    ...
    foreach ($workdays as $workday) {
        ...
        $user_days['break_time'] = $workday->break_time;
    }
    $min_time = array();
    if (isset($user_days['break_time'])) {
        $min_time = explode(":", $user_days['break_time']);
    }
    if (isset($min_time[0])) {
    ...
    echo CHtml::dropDownList('bth[' . $data->id . ']', $min_select, array(
        '00' => '00 hrs',
        '01' => '01 hrs',
        '02' => '02 hrs',
        '03' => '03 hrs',
    ...
    echo CHtml::dropDownList('btm[' . $data->id . ']', $min_time_2, array(
        '00' => '00 min',
        '15' => '15 min',
        '30' => '30 min',
        '45' => '45 min',
